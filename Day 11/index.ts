...
let users : string [] = ["admin","laibamarrie","jane","Komal","zaid"];
if (users.length === 0){
...
let current_users: string[] = ["Hina", "Ali", "Areeba", "Maria", "Lily"];
let new_users: string[] = ["Vivian", "Hina", "Areeba", "Hania", "Saiqa"];
