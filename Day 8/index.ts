...
let name_1 : string = "laiba"
let name_2 : string = "laiba marrie"
let name_3 : string = "miss laiba marrie"
...
let rivers: string[] = ["Jhelum River","Indus River","Sutlej River","Hingol River","Neelum River"];
