...
let invitations : string [] = ["Kathryn","Bilal"];
...
let mountains: string[] = ["Mount Everest","Nanda Devi","Rakaposhi","Mount Elbrus","K2"];
...
let person: {name: string, fname: string, age: number} = {name:"Laiba Marrie", fname: "female", age: 23};
console.log(person);